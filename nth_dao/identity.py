...
# MI-3 (review fix 2026-06-08): canonical JSON now lives in its own
# module ``nth_dao.canonical_json``. These re-exports keep the long-
# standing ``from nth_dao.identity import canonical_json`` imports
# working — every downstream module (mandate, group_registry, gossip,
# execution_receipt, a2a_card, web, …) doesn't need to change in the
# same commit. New code should prefer the canonical location.
from nth_dao.canonical_json import (  # noqa: F401  re-export
